...
function Hero() {
  return (
    <div className='w-full h-screen  flex flex-col justify-between bg-blue  '>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto mb-60 mt-10'>
          <Fade left>
           <div className='flex flex-col justify-center md:items-start w-full px-10 py-10  shadow-2xl  bg-white'>
